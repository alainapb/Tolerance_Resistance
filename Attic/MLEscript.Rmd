...
First part of code combines data from various spreadsheets (and we will strive to make a single master spreadsheet for all future experiments!)
...
sobolDesign(lower = c(u1 = log(0.0001),         ## genotype-specific per-spore susceptibility
                      u2 = log(0.0001),
                      u3 = log(0.0001),
                      u4 = log(0.0001),
...
nll2 <- function(params, data, mod) {
  ...
  for (id in unique(data$ID)) {                                  ## For each GENOTYPE value, compute the NLL of its set of parameter values and add this to the existing total
