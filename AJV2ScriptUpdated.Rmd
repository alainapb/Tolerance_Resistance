...
all.data.joined <- all.data.joined %>% 
  select(-c( "Length_Day_7", "Length_Day_20", "DOB", "Total Offspring"))
...
#in this case, it is better to use a summarise instead than a mutate and a distinct. You will get the same result, but code is much cleaner
...
# here you have some Nan in the spores_ul column of filtered_df dataframe. 
# Is it expected? or they are coming from an error somewhere earlier in the 
...
# here you have some Nan in the spores_ul column of filtered_df dataframe. 
# Is it expected? or they are coming from an error somewhere earlier in the code? the same is true for all following plots up to line 426
