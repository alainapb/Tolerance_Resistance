...
#A'45
with(filter(animal_mean, Genotype == "A'45"), plot(fr_sw ~ mean_size_animal))
with(filter(animal_mean, Genotype == "A'45"), cor.test(fr_sw, mean_size_animal)) #r=.18 


summary(with(filter(animal_mean, Genotype == "A'45"), lm(fr_sw~ mean_size_animal))) 
# r =  0.03, and R2 = 0.02
```
...
ggsave("~/Documents/Publications/Tolerance_Resistance/figures/figure_1.png", width = 5, height = 8)
```
